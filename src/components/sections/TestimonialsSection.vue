              ...
              <div class="card__author">
                <div class="card__avatar-wrapper">
                  <img
                    ...
                    :alt="locale === 'ar' ? testimonial.name : testimonial.name_en"
                    class="card__avatar"
                    draggable="false"
                  />
        ...
        >
          <div class="side-card__inner">
            ...
            <p class="side-card__text">
              {{
                locale === 'ar'
                  ? testimonials[(currentIndex + offset + testimonials.length) % testimonials.length].content.slice(0, 80)
            ...
            <div class="side-card__author">
              ...
              <span>{{
                locale === 'ar'
                  ? testimonials[(currentIndex + offset + testimonials.length) % testimonials.length].name
                  : testimonials[(currentIndex + offset + testimonials.length) % testimonials.length].name_en
              }}</span>
            </div>
          </div>
        </div>
